...
var EventManager = function () {
  _createClass(EventManager, [{
    ...
    value: function handleSingle(elementOrSelector) {
      ...
      this.handlers.filter(function (handlerInstance) {
        return handlerInstance.handler.element === elementOrSelector || handlerInstance.handler.selector === elementOrSelector;
  ...
  function EventManager() {
    ...
    this.handlers = handlers.map(function (handler) {
      return new Handler(handler, options);
    });
  }
